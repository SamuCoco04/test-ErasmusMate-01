...
export default function MapExplorerPage() {
  ...
  const filteredPins = mapPins.filter((pin) => {
    ...
    const matchesDate = pin.date >= fromDate;
      ...
      <div className="grid gap-6 lg:grid-cols-[340px_1fr_340px]">
          ...
          <CardContent className="space-y-4 text-sm">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                value={category}
                onChange={(e) => setCategory(e.target.value as MapCategory | "all")}
              >
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className={SELECT_CLASS}
                value={contentType}
                onChange={(e) => setContentType(e.target.value as MapContentType | "all")}
              >
        ...
        <Card className="overflow-hidden">
          <CardHeader className="border-b">
            ...
            <CardDescription>
              Public Erasmus place contexts only. Click a pin to preview it. Pins represent approved content-place associations, not student live positions.
            </CardDescription>
          </CardHeader>
            ...
            {filteredPins.map((pin) => {
              ...
              return (
                <button
                  ...
                  className={`absolute -translate-x-1/2 -translate-y-1/2 rounded-full border p-1.5 shadow transition-colors ${
                    isSelected
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Preview the selected pin and navigate to related recommendations/opinions.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 text-sm">
            {selectedPin ? (
              <>
