...
export const institutionalMenus: Record<Role, NavItem[]> = {
  Student: [
    ...
    { label: "My Mobility Record", href: "/student/my-mobility", section: "institutional" },
    {
      ...
      activePrefixes: ["/student/procedures", "/student/submissions", "/student/submissions/[id]"],
    },
    {
      label: "Signatures",
  ...
  Coordinator: [
    { label: "Dashboard", href: "/coordinator/dashboard", section: "institutional" },
    {
      ...
      section: "institutional",
      activePrefixes: ["/coordinator/review-queue", "/coordinator/review", "/coordinator/review/[id]"],
    },
